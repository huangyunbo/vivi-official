...
$(function(){
	(function(){
	    ...
	    if(args.nickname){
	        ...
	        $('title').text(args.nickname + ' Invite you to join ViVi video chat');
	    }
	    if(args.invitecode){
	...
	(function(){
		...
		var android_url = 'https://play.google.com/store/apps/details?id=com.vivichatapp.vivi',
			ios_url = 'https://itunes.apple.com/app/vivi-chat/id1321240205?mt=8',
